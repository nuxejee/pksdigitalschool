...
tersebut! 
        ...
        */
        ...
        echo "<label>Panjang Pertama: </label> $a, <br>";
        echo "<label>Jumlah Kata Pertama: </label> $b <br>";
        echo   "<br>"; 
        echo "<label>Panjang Kedua: </label> $c, <br>";
        echo "<label>Jumlah Kata Kedua: </label> $d <br>";
        ...
        */
        ...
        $a = substr($string2, 2,4);
        $b = substr($string2, 7,3);
        echo "Kata kedua: $a " ;
        echo "<br> Kata Ketiga: $b " ;
        ...
        */
        ...
        echo "String: \"$string3\" "; 
       $a =  str_replace("Good!","awesome",$string3);
       echo "String: \"$a\" "; 
